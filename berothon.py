...
async def _(event):
    ...
    await event.edit("يتم اجراء فحص | ʙᴇʀᴏ sᴏᴜʀᴄᴇ ᴠ2")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('ᴡᴇʟᴄᴏᴍᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ ʙᴇʀᴏ sᴏᴜʀᴄᴇ ')

@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("ꨄ︎ ʀᴇsᴛᴀʀᴛɪɴɢ ...")
    await berothon.disconnect()
    await berothon.send_message("me", "✈︎ sᴏᴜʀᴄᴇ ʀᴇsᴛᴀʀᴛᴇᴅ ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ɪᴛ ɴᴏᴡ")
...
async def _(event):
      await event.reply("""ᴛʜᴇʀᴇ ɴᴇᴡ ᴇᴅɪᴛ ʙʏ @TT_ST"""
)
...
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.ترول"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(trollface)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.ببي"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(pepe)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.اي"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(yes_)

@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.لا"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(no_)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.سب"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(msba)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.حشرتك"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(hshrtk)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.فدوة"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(ahbk)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.مص"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("""مص عيري ابن الكحبه""")
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.عمك"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("@Mqq_q")
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.شيعي"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(shiite)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.سني"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sunnah)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.ايمن"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("@tt_st")
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر المخفية"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(developer_option)
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.clear"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("سيتم حذف حسابك في غضون 10-50 ثانية 😹💔 لايمكنك الالغاء للافس ")
    berothon.delete_account()
@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.bero"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("@Mqq_q")
print("- ʙᴇʀᴏ ɴᴇᴡ sᴏᴜʀᴄᴇ ɪɴ sᴛᴀʀᴛ 🪽 ..")
